    ...
    <div id="editor-general" class='main'>
      <h1>Editor: General</h1>
          ...
          <div class="form-check">
            ...
            <label class="form-check-label" for="editor-general-continue_comment">
              An enter keypress at the end of a line that contains a non-empty comment will continue the comment on the next line. This can be cancelled by pressing enter again. You must also set <code>"editor.formatOnType": true"</code>
            </label>
          </div>
