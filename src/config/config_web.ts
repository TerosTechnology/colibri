...
<div class="col-sm-12 main h-100">
    ...
    <div class="card h-100" id="editor-general">
      ...
      <br>
          ...
          <li class="list-group-item">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="" id="editor-general-shutter_comment_shortcuts">
              <label class="form-check-label" for="editor-general-shutter_comment_shortcuts">
                Shutter mode: an enter keypress at the end of a line that contains a non-empty comment will continue the comment on the next line. This can be cancelled by pressing enter again. You must also set <code>"editor.formatOnType": true"</code>
              </label>
            </div>
          </li>
          ...
          <li class="list-group-item">
            <div class="mb-3">
              <label for="editor-general-shutter_block_width" class="form-label">Width of block comment elements inserted by stutter completions</label>
              <input type='number' class="form-control" id="editor-general-shutter_block_width" rows="3"></input>
            </div>
          </li>
          ...
          <li class="list-group-item">
            <div class="mb-3">
              <label for="editor-general-shutter_max_width" class="form-label">Max width of block comment elements inserted by stutter completions. Set to zero to disable.</label>
              <input type='number' class="form-control" id="editor-general-shutter_max_width" rows="3"></input>
            </div>
          </li>
          ...
          <li class="list-group-item">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="" id="editor-general-shutter_delimiters">
              <label class="form-check-label" for="editor-general-shutter_delimiters">
                Shutter mode: enable Delimiter Shortcuts
              </label>
            </div>
          </li>
          ...
          <li class="list-group-item">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="" id="editor-general-shutter_bracket_shortcuts">
              <label class="form-check-label" for="editor-general-shutter_bracket_shortcuts">
                Shutter mode: enable Bracket Shortcuts
              </label>
            </div>
          </li>
...
<script>
  ...
  function get_config(){
    ...
    element_value = document.getElementById("editor-general-shutter_comment_shortcuts").checked;
    config["editor"]["general"]["shutter_comment_shortcuts"] = element_value
    element_value = document.getElementById("editor-general-shutter_block_width").value;
    config["editor"]["general"]["shutter_block_width"] = element_value
    element_value = document.getElementById("editor-general-shutter_max_width").value;
    config["editor"]["general"]["shutter_max_width"] = element_value
    element_value = document.getElementById("editor-general-shutter_delimiters").checked;
    config["editor"]["general"]["shutter_delimiters"] = element_value
    element_value = document.getElementById("editor-general-shutter_bracket_shortcuts").checked;
    config["editor"]["general"]["shutter_bracket_shortcuts"] = element_value
    config["formatter"] = {}
  ...
  function set_config(config){
    ...
    document.getElementById("editor-general-shutter_comment_shortcuts").checked = config["editor"]["general"]["shutter_comment_shortcuts"];
    document.getElementById("editor-general-shutter_block_width").value = config["editor"]["general"]["shutter_block_width"];
    document.getElementById("editor-general-shutter_max_width").value = config["editor"]["general"]["shutter_max_width"];
    document.getElementById("editor-general-shutter_delimiters").checked = config["editor"]["general"]["shutter_delimiters"];
    document.getElementById("editor-general-shutter_bracket_shortcuts").checked = config["editor"]["general"]["shutter_bracket_shortcuts"];
