...
<article class="markdown-body">
  ...
  <div id="tools-veriblelint" class='main'>
    ...
    <label>Ruleset.</label>
        <br>
        <select name='select' id='tools-veriblelint-ruleset'>
                <option value='default'>Default</option>
                <option value='all'>All</option>
                <option value='none'>None</option>
        </select>
      <br><br>
    <label>Extra command line arguments passed to the Verible tool.</label>
      <input type='input' id='tools-veriblelint-verible_lint_args' class='radio-button'>
      <br><br>
    <label>What rules to use. Prefix a rule name with “-” to disable it.</label>
      <input type='input' id='tools-veriblelint-rules' class='radio-button'>
      <br><br>
    <label></label>
      <br><br>
    <label></label>
...
<div id="div_button">
  ...
  <button id="button_load" class="button" type="button" onclick="load_config(event)">Load</button>
  <button id="button_export" class="button" type="button" onclick="export_config(event)">Export</button>
</div>
...
<script>
  ...
  function get_config(){
    ...
    element_value = document.getElementById("tools-veriblelint-ruleset").value;
    config["tools"]["veriblelint"]["ruleset"] = element_value
    element_value = document.getElementById("tools-veriblelint-verible_lint_args").value.split(',');
    config["tools"]["veriblelint"]["verible_lint_args"] = element_value
    element_value = document.getElementById("tools-veriblelint-rules").value.split(',');
    config["tools"]["veriblelint"]["rules"] = element_value
  ...
  function set_config(config){
    ...
    document.getElementById("tools-veriblelint-ruleset").value = config["tools"]["veriblelint"]["ruleset"];
    element_value = document.getElementById("tools-veriblelint-verible_lint_args").value = String(config["tools"]["veriblelint"]["verible_lint_args"]);
    element_value = document.getElementById("tools-veriblelint-rules").value = String(config["tools"]["veriblelint"]["rules"]);
