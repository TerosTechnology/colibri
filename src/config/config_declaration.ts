...
export function get_config_from_json(json_config: any): e_config {
    ...
    const current_value_63 = json_config['templates']['general']['header_file_path'];
    if (typeof current_value_63 === 'string'){
        default_config['templates']['general']['header_file_path'] = current_value_63;
    }
            
    // templates -> general -> indent
    const current_value_64 = json_config['templates']['general']['indent'];
    if (typeof current_value_64 === 'string'){
        default_config['templates']['general']['indent'] = current_value_64;
    }
            
    // templates -> general -> clock_generation_style
    const current_value_65 = json_config['templates']['general']['clock_generation_style'];
    ...
    const current_value_73 = json_config['tools']['ascenlint']['installation_path'];
    if (typeof current_value_73 === 'string'){
        default_config['tools']['ascenlint']['installation_path'] = current_value_73;
    }
            
    // tools -> ascenlint -> ascentlint_options
    const current_value_74 = json_config['tools']['ascenlint']['ascentlint_options'];
    if (Array.isArray(current_value_74)){
        default_config['tools']['ascenlint']['ascentlint_options'] = current_value_74;
    }
            
    // tools -> cocotb -> installation_path
    const current_value_75 = json_config['tools']['cocotb']['installation_path'];
    if (typeof current_value_75 === 'string'){
        default_config['tools']['cocotb']['installation_path'] = current_value_75;
    }
            
    // tools -> cocotb -> simulator_name
    const current_value_76 = json_config['tools']['cocotb']['simulator_name'];
    if ( current_value_76 === "icarus"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.icarus;
    }
    if ( current_value_76 === "verilator"){
    ...
    if ( current_value_76 === "cvc"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.cvc;
    }
            
    // tools -> cocotb -> compile_args
    const current_value_77 = json_config['tools']['cocotb']['compile_args'];
    if (typeof current_value_77 === 'string'){
        default_config['tools']['cocotb']['compile_args'] = current_value_77;
    }
            
    // tools -> cocotb -> run_args
    const current_value_78 = json_config['tools']['cocotb']['run_args'];
    if (typeof current_value_78 === 'string'){
        default_config['tools']['cocotb']['run_args'] = current_value_78;
    }
            
    // tools -> cocotb -> plusargs
    const current_value_79 = json_config['tools']['cocotb']['plusargs'];
    if (typeof current_value_79 === 'string'){
        default_config['tools']['cocotb']['plusargs'] = current_value_79;
    }
            
    // tools -> diamond -> installation_path
    const current_value_80 = json_config['tools']['diamond']['installation_path'];
    if (typeof current_value_80 === 'string'){
        default_config['tools']['diamond']['installation_path'] = current_value_80;
    }
            
    // tools -> diamond -> part
    const current_value_81 = json_config['tools']['diamond']['part'];
    if (typeof current_value_81 === 'string'){
        default_config['tools']['diamond']['part'] = current_value_81;
    }
            
    // tools -> ghdl -> installation_path
    const current_value_82 = json_config['tools']['ghdl']['installation_path'];
    if (typeof current_value_82 === 'string'){
        default_config['tools']['ghdl']['installation_path'] = current_value_82;
    }
            
    // tools -> ghdl -> waveform
    const current_value_83 = json_config['tools']['ghdl']['waveform'];
    if ( current_value_83 === "vcd"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.vcd;
    }
    if ( current_value_83 === "ghw"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.ghw;
    }
            
    // tools -> ghdl -> analyze_options
    const current_value_84 = json_config['tools']['ghdl']['analyze_options'];
    if (Array.isArray(current_value_84)){
        default_config['tools']['ghdl']['analyze_options'] = current_value_84;
    }
            
    // tools -> ghdl -> run_options
    const current_value_85 = json_config['tools']['ghdl']['run_options'];
    if (Array.isArray(current_value_85)){
        default_config['tools']['ghdl']['run_options'] = current_value_85;
    }
            
    // tools -> icarus -> installation_path
    const current_value_86 = json_config['tools']['icarus']['installation_path'];
    if (typeof current_value_86 === 'string'){
        default_config['tools']['icarus']['installation_path'] = current_value_86;
    }
            
    // tools -> icarus -> timescale
    const current_value_87 = json_config['tools']['icarus']['timescale'];
    if (typeof current_value_87 === 'string'){
        default_config['tools']['icarus']['timescale'] = current_value_87;
    }
            
    // tools -> icarus -> iverilog_options
    const current_value_88 = json_config['tools']['icarus']['iverilog_options'];
    if (Array.isArray(current_value_88)){
        default_config['tools']['icarus']['iverilog_options'] = current_value_88;
    }
            
    // tools -> icestorm -> installation_path
    const current_value_89 = json_config['tools']['icestorm']['installation_path'];
    if (typeof current_value_89 === 'string'){
        default_config['tools']['icestorm']['installation_path'] = current_value_89;
    }
            
    // tools -> icestorm -> pnr
    const current_value_90 = json_config['tools']['icestorm']['pnr'];
    if ( current_value_90 === "arachne"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.arachne;
    }
    if ( current_value_90 === "next"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.next;
    }
    if ( current_value_90 === "none"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.none;
    }
            
    // tools -> icestorm -> arch
    const current_value_91 = json_config['tools']['icestorm']['arch'];
    if ( current_value_91 === "xilinx"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.xilinx;
    }
    if ( current_value_91 === "ice40"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ice40;
    }
    if ( current_value_91 === "ecp5"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ecp5;
    }
            
    // tools -> icestorm -> output_format
    const current_value_92 = json_config['tools']['icestorm']['output_format'];
    if ( current_value_92 === "json"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.json;
    }
    if ( current_value_92 === "edif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.edif;
    }
    if ( current_value_92 === "blif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.blif;
    }
            
    // tools -> icestorm -> yosys_as_subtool
    const current_value_93 = json_config['tools']['icestorm']['yosys_as_subtool'];
    if (current_value_93 === true || current_value_93 === false){
        default_config['tools']['icestorm']['yosys_as_subtool'] = current_value_93;
    }
            
    // tools -> icestorm -> makefile_name
    const current_value_94 = json_config['tools']['icestorm']['makefile_name'];
    if (typeof current_value_94 === 'string'){
        default_config['tools']['icestorm']['makefile_name'] = current_value_94;
    }
            
    // tools -> icestorm -> arachne_pnr_options
    const current_value_95 = json_config['tools']['icestorm']['arachne_pnr_options'];
    if (Array.isArray(current_value_95)){
        default_config['tools']['icestorm']['arachne_pnr_options'] = current_value_95;
    }
            
    // tools -> icestorm -> nextpnr_options
    const current_value_96 = json_config['tools']['icestorm']['nextpnr_options'];
    if (Array.isArray(current_value_96)){
        default_config['tools']['icestorm']['nextpnr_options'] = current_value_96;
    }
            
    // tools -> icestorm -> yosys_synth_options
    const current_value_97 = json_config['tools']['icestorm']['yosys_synth_options'];
    if (Array.isArray(current_value_97)){
        default_config['tools']['icestorm']['yosys_synth_options'] = current_value_97;
    }
            
    // tools -> ise -> installation_path
    const current_value_98 = json_config['tools']['ise']['installation_path'];
    if (typeof current_value_98 === 'string'){
        default_config['tools']['ise']['installation_path'] = current_value_98;
    }
            
    // tools -> ise -> family
    const current_value_99 = json_config['tools']['ise']['family'];
    if (typeof current_value_99 === 'string'){
        default_config['tools']['ise']['family'] = current_value_99;
    }
            
    // tools -> ise -> device
    const current_value_100 = json_config['tools']['ise']['device'];
    if (typeof current_value_100 === 'string'){
        default_config['tools']['ise']['device'] = current_value_100;
    }
            
    // tools -> ise -> package
    const current_value_101 = json_config['tools']['ise']['package'];
    if (typeof current_value_101 === 'string'){
        default_config['tools']['ise']['package'] = current_value_101;
    }
            
    // tools -> ise -> speed
    const current_value_102 = json_config['tools']['ise']['speed'];
    if (typeof current_value_102 === 'string'){
        default_config['tools']['ise']['speed'] = current_value_102;
    }
            
    // tools -> isem -> installation_path
    const current_value_103 = json_config['tools']['isem']['installation_path'];
    if (typeof current_value_103 === 'string'){
        default_config['tools']['isem']['installation_path'] = current_value_103;
    }
            
    // tools -> isem -> fuse_options
    const current_value_104 = json_config['tools']['isem']['fuse_options'];
    if (Array.isArray(current_value_104)){
        default_config['tools']['isem']['fuse_options'] = current_value_104;
    }
            
    // tools -> isem -> isim_options
    const current_value_105 = json_config['tools']['isem']['isim_options'];
    if (Array.isArray(current_value_105)){
        default_config['tools']['isem']['isim_options'] = current_value_105;
    }
            
    // tools -> modelsim -> installation_path
    const current_value_106 = json_config['tools']['modelsim']['installation_path'];
    if (typeof current_value_106 === 'string'){
        default_config['tools']['modelsim']['installation_path'] = current_value_106;
    }
            
    // tools -> modelsim -> vcom_options
    const current_value_107 = json_config['tools']['modelsim']['vcom_options'];
    if (Array.isArray(current_value_107)){
        default_config['tools']['modelsim']['vcom_options'] = current_value_107;
    }
            
    // tools -> modelsim -> vlog_options
    const current_value_108 = json_config['tools']['modelsim']['vlog_options'];
    if (Array.isArray(current_value_108)){
        default_config['tools']['modelsim']['vlog_options'] = current_value_108;
    }
            
    // tools -> modelsim -> vsim_options
    const current_value_109 = json_config['tools']['modelsim']['vsim_options'];
    if (Array.isArray(current_value_109)){
        default_config['tools']['modelsim']['vsim_options'] = current_value_109;
    }
            
    // tools -> morty -> installation_path
    const current_value_110 = json_config['tools']['morty']['installation_path'];
    if (typeof current_value_110 === 'string'){
        default_config['tools']['morty']['installation_path'] = current_value_110;
    }
            
    // tools -> morty -> morty_options
    const current_value_111 = json_config['tools']['morty']['morty_options'];
    if (Array.isArray(current_value_111)){
        default_config['tools']['morty']['morty_options'] = current_value_111;
    }
            
    // tools -> quartus -> installation_path
    const current_value_112 = json_config['tools']['quartus']['installation_path'];
    if (typeof current_value_112 === 'string'){
        default_config['tools']['quartus']['installation_path'] = current_value_112;
    }
            
    // tools -> quartus -> family
    const current_value_113 = json_config['tools']['quartus']['family'];
    if (typeof current_value_113 === 'string'){
        default_config['tools']['quartus']['family'] = current_value_113;
    }
            
    // tools -> quartus -> device
    const current_value_114 = json_config['tools']['quartus']['device'];
    if (typeof current_value_114 === 'string'){
        default_config['tools']['quartus']['device'] = current_value_114;
    }
            
    // tools -> quartus -> cable
    const current_value_115 = json_config['tools']['quartus']['cable'];
    if (typeof current_value_115 === 'string'){
        default_config['tools']['quartus']['cable'] = current_value_115;
    }
            
    // tools -> quartus -> board_device_index
    const current_value_116 = json_config['tools']['quartus']['board_device_index'];
    if (typeof current_value_116 === 'string'){
        default_config['tools']['quartus']['board_device_index'] = current_value_116;
    }
            
    // tools -> quartus -> pnr
    const current_value_117 = json_config['tools']['quartus']['pnr'];
    if ( current_value_117 === "default"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.default;
    }
    if ( current_value_117 === "dse"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.dse;
    }
    if ( current_value_117 === "none"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.none;
    }
            
    // tools -> quartus -> dse_options
    const current_value_118 = json_config['tools']['quartus']['dse_options'];
    if (Array.isArray(current_value_118)){
        default_config['tools']['quartus']['dse_options'] = current_value_118;
    }
            
    // tools -> quartus -> quartus_options
    const current_value_119 = json_config['tools']['quartus']['quartus_options'];
    if (Array.isArray(current_value_119)){
        default_config['tools']['quartus']['quartus_options'] = current_value_119;
    }
            
    // tools -> radiant -> installation_path
    const current_value_120 = json_config['tools']['radiant']['installation_path'];
    if (typeof current_value_120 === 'string'){
        default_config['tools']['radiant']['installation_path'] = current_value_120;
    }
            
    // tools -> radiant -> part
    const current_value_121 = json_config['tools']['radiant']['part'];
    if (typeof current_value_121 === 'string'){
        default_config['tools']['radiant']['part'] = current_value_121;
    }
            
    // tools -> rivierapro -> installation_path
    const current_value_122 = json_config['tools']['rivierapro']['installation_path'];
    if (typeof current_value_122 === 'string'){
        default_config['tools']['rivierapro']['installation_path'] = current_value_122;
    }
            
    // tools -> rivierapro -> compilation_mode
    const current_value_123 = json_config['tools']['rivierapro']['compilation_mode'];
    if (typeof current_value_123 === 'string'){
        default_config['tools']['rivierapro']['compilation_mode'] = current_value_123;
    }
            
    // tools -> rivierapro -> vlog_options
    const current_value_124 = json_config['tools']['rivierapro']['vlog_options'];
    if (Array.isArray(current_value_124)){
        default_config['tools']['rivierapro']['vlog_options'] = current_value_124;
    }
            
    // tools -> rivierapro -> vsim_options
    const current_value_125 = json_config['tools']['rivierapro']['vsim_options'];
    if (Array.isArray(current_value_125)){
        default_config['tools']['rivierapro']['vsim_options'] = current_value_125;
    }
            
    // tools -> siliconcompiler -> installation_path
    const current_value_126 = json_config['tools']['siliconcompiler']['installation_path'];
    if (typeof current_value_126 === 'string'){
        default_config['tools']['siliconcompiler']['installation_path'] = current_value_126;
    }
            
    // tools -> siliconcompiler -> target
    const current_value_127 = json_config['tools']['siliconcompiler']['target'];
    if (typeof current_value_127 === 'string'){
        default_config['tools']['siliconcompiler']['target'] = current_value_127;
    }
            
    // tools -> siliconcompiler -> server_enable
    const current_value_128 = json_config['tools']['siliconcompiler']['server_enable'];
    if (current_value_128 === true || current_value_128 === false){
        default_config['tools']['siliconcompiler']['server_enable'] = current_value_128;
    }
            
    // tools -> siliconcompiler -> server_address
    const current_value_129 = json_config['tools']['siliconcompiler']['server_address'];
    if (typeof current_value_129 === 'string'){
        default_config['tools']['siliconcompiler']['server_address'] = current_value_129;
    }
            
    // tools -> siliconcompiler -> server_username
    const current_value_130 = json_config['tools']['siliconcompiler']['server_username'];
    if (typeof current_value_130 === 'string'){
        default_config['tools']['siliconcompiler']['server_username'] = current_value_130;
    }
            
    // tools -> siliconcompiler -> server_password
    const current_value_131 = json_config['tools']['siliconcompiler']['server_password'];
    if (typeof current_value_131 === 'string'){
        default_config['tools']['siliconcompiler']['server_password'] = current_value_131;
    }
    ...
    const current_value_157 = json_config['tools']['veriblelint']['installation_path'];
    if (typeof current_value_157 === 'string'){
        default_config['tools']['veriblelint']['installation_path'] = current_value_157;
    }
    ...
    if ( current_value_196 === "xilinx"){
        default_config['tools']['openfpga']['arch'] = e_tools_openfpga_arch.xilinx;
    }
    if ( current_value_196 === "ice40"){
        default_config['tools']['openfpga']['arch'] = e_tools_openfpga_arch.ice40;
    }
    if ( current_value_196 === "ecp5"){
        default_config['tools']['openfpga']['arch'] = e_tools_openfpga_arch.ecp5;
    }
            
    // tools -> openfpga -> output_format
    const current_value_197 = json_config['tools']['openfpga']['output_format'];
    if ( current_value_197 === "json"){
        default_config['tools']['openfpga']['output_format'] = e_tools_openfpga_output_format.json;
    }
    if ( current_value_197 === "edif"){
        default_config['tools']['openfpga']['output_format'] = e_tools_openfpga_output_format.edif;
    }
    if ( current_value_197 === "blif"){
        default_config['tools']['openfpga']['output_format'] = e_tools_openfpga_output_format.blif;
    }
            
    // tools -> openfpga -> yosys_as_subtool
    const current_value_198 = json_config['tools']['openfpga']['yosys_as_subtool'];
    if (current_value_198 === true || current_value_198 === false){
        default_config['tools']['openfpga']['yosys_as_subtool'] = current_value_198;
    }
            
    // tools -> openfpga -> makefile_name
    const current_value_199 = json_config['tools']['openfpga']['makefile_name'];
    if (typeof current_value_199 === 'string'){
        default_config['tools']['openfpga']['makefile_name'] = current_value_199;
    }
            
    // tools -> openfpga -> script_name
    const current_value_200 = json_config['tools']['openfpga']['script_name'];
    if (typeof current_value_200 === 'string'){
        default_config['tools']['openfpga']['script_name'] = current_value_200;
    }
            
    // tools -> openfpga -> yosys_synth_options
    const current_value_201 = json_config['tools']['openfpga']['yosys_synth_options'];
    if (Array.isArray(current_value_201)){
        default_config['tools']['openfpga']['yosys_synth_options'] = current_value_201;
    }
    ...
    const current_value_203 = json_config['tools']['nvc']['installation_path'];
    if (typeof current_value_203 === 'string'){
        default_config['tools']['nvc']['installation_path'] = current_value_203;
    }
            
    // tools -> questa -> installation_path
    const current_value_204 = json_config['tools']['questa']['installation_path'];
    if (typeof current_value_204 === 'string'){
        default_config['tools']['questa']['installation_path'] = current_value_204;
    }
