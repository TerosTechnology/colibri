...
export function get_config_from_json(json_config: any): e_config {
    ...
    const current_value_4 = json_config['documentation']['general']['language'];
    if ( current_value_4 === "english"){
        default_config['documentation']['general']['language'] = e_documentation_general_language.english;
    }
    if ( current_value_4 === "russian"){
        default_config['documentation']['general']['language'] = e_documentation_general_language.russian;
    }
            
    // documentation -> general -> symbol_vhdl
    const current_value_5 = json_config['documentation']['general']['symbol_vhdl'];
    if (typeof current_value_5 === 'string'){
        default_config['documentation']['general']['symbol_vhdl'] = current_value_5;
    }
            
    // documentation -> general -> symbol_verilog
    const current_value_6 = json_config['documentation']['general']['symbol_verilog'];
    if (typeof current_value_6 === 'string'){
        default_config['documentation']['general']['symbol_verilog'] = current_value_6;
    }
            
    // documentation -> general -> dependency_graph
    const current_value_7 = json_config['documentation']['general']['dependency_graph'];
    if (current_value_7 === true || current_value_7 === false){
        default_config['documentation']['general']['dependency_graph'] = current_value_7;
    }
            
    // documentation -> general -> self_contained
    const current_value_8 = json_config['documentation']['general']['self_contained'];
    if (current_value_8 === true || current_value_8 === false){
        default_config['documentation']['general']['self_contained'] = current_value_8;
    }
            
    // documentation -> general -> fsm
    const current_value_9 = json_config['documentation']['general']['fsm'];
    if (current_value_9 === true || current_value_9 === false){
        default_config['documentation']['general']['fsm'] = current_value_9;
    }
            
    // documentation -> general -> ports
    const current_value_10 = json_config['documentation']['general']['ports'];
    if ( current_value_10 === "all"){
        default_config['documentation']['general']['ports'] = e_documentation_general_ports.all;
    }
    if ( current_value_10 === "only_commented"){
        default_config['documentation']['general']['ports'] = e_documentation_general_ports.only_commented;
    }
    if ( current_value_10 === "none"){
        default_config['documentation']['general']['ports'] = e_documentation_general_ports.none;
    }
            
    // documentation -> general -> generics
    const current_value_11 = json_config['documentation']['general']['generics'];
    ...
    const current_value_12 = json_config['documentation']['general']['instantiations'];
    ...
    const current_value_13 = json_config['documentation']['general']['signals'];
    ...
    const current_value_14 = json_config['documentation']['general']['constants'];
    ...
    const current_value_15 = json_config['documentation']['general']['types'];
    ...
    const current_value_16 = json_config['documentation']['general']['process'];
    ...
    const current_value_17 = json_config['documentation']['general']['functions'];
    ...
    const current_value_18 = json_config['documentation']['general']['magic_config_path'];
    if (typeof current_value_18 === 'string'){
        default_config['documentation']['general']['magic_config_path'] = current_value_18;
    }
            
    // editor -> general -> stutter_comment_shortcuts
    const current_value_19 = json_config['editor']['general']['stutter_comment_shortcuts'];
    if (current_value_19 === true || current_value_19 === false){
        default_config['editor']['general']['stutter_comment_shortcuts'] = current_value_19;
    }
            
    // editor -> general -> stutter_block_width
    const current_value_20 = json_config['editor']['general']['stutter_block_width'];
    if (typeof current_value_20 === 'number'){
        default_config['editor']['general']['stutter_block_width'] = current_value_20;
    }
            
    // editor -> general -> stutter_max_width
    const current_value_21 = json_config['editor']['general']['stutter_max_width'];
    if (typeof current_value_21 === 'number'){
        default_config['editor']['general']['stutter_max_width'] = current_value_21;
    }
            
    // editor -> general -> stutter_delimiters
    const current_value_22 = json_config['editor']['general']['stutter_delimiters'];
    if (current_value_22 === true || current_value_22 === false){
        default_config['editor']['general']['stutter_delimiters'] = current_value_22;
    }
            
    // editor -> general -> stutter_bracket_shortcuts
    const current_value_23 = json_config['editor']['general']['stutter_bracket_shortcuts'];
    if (current_value_23 === true || current_value_23 === false){
        default_config['editor']['general']['stutter_bracket_shortcuts'] = current_value_23;
    }
            
    // formatter -> general -> formatter_verilog
    const current_value_24 = json_config['formatter']['general']['formatter_verilog'];
    if ( current_value_24 === "istyle"){
        default_config['formatter']['general']['formatter_verilog'] = e_formatter_general_formatter_verilog.istyle;
    }
    if ( current_value_24 === "s3sv"){
        default_config['formatter']['general']['formatter_verilog'] = e_formatter_general_formatter_verilog.s3sv;
    }
    if ( current_value_24 === "verible"){
    ...
    const current_value_25 = json_config['formatter']['general']['formatter_vhdl'];
    if ( current_value_25 === "standalone"){
        default_config['formatter']['general']['formatter_vhdl'] = e_formatter_general_formatter_vhdl.standalone;
    }
    if ( current_value_25 === "vsg"){
        default_config['formatter']['general']['formatter_vhdl'] = e_formatter_general_formatter_vhdl.vsg;
    }
            
    // formatter -> istyle -> style
    const current_value_26 = json_config['formatter']['istyle']['style'];
    if ( current_value_26 === "ansi"){
        default_config['formatter']['istyle']['style'] = e_formatter_istyle_style.ansi;
    }
    if ( current_value_26 === "kr"){
        default_config['formatter']['istyle']['style'] = e_formatter_istyle_style.kr;
    }
    if ( current_value_26 === "gnu"){
        default_config['formatter']['istyle']['style'] = e_formatter_istyle_style.gnu;
    }
    if ( current_value_26 === "indent_only"){
        default_config['formatter']['istyle']['style'] = e_formatter_istyle_style.indent_only;
    }
            
    // formatter -> istyle -> indentation_size
    const current_value_27 = json_config['formatter']['istyle']['indentation_size'];
    if (typeof current_value_27 === 'number'){
        default_config['formatter']['istyle']['indentation_size'] = current_value_27;
    }
            
    // formatter -> s3sv -> one_bind_per_line
    const current_value_28 = json_config['formatter']['s3sv']['one_bind_per_line'];
    if (current_value_28 === true || current_value_28 === false){
        default_config['formatter']['s3sv']['one_bind_per_line'] = current_value_28;
    }
            
    // formatter -> s3sv -> one_declaration_per_line
    const current_value_29 = json_config['formatter']['s3sv']['one_declaration_per_line'];
    if (current_value_29 === true || current_value_29 === false){
        default_config['formatter']['s3sv']['one_declaration_per_line'] = current_value_29;
    }
            
    // formatter -> s3sv -> use_tabs
    const current_value_30 = json_config['formatter']['s3sv']['use_tabs'];
    if (current_value_30 === true || current_value_30 === false){
        default_config['formatter']['s3sv']['use_tabs'] = current_value_30;
    }
            
    // formatter -> s3sv -> indentation_size
    const current_value_31 = json_config['formatter']['s3sv']['indentation_size'];
    if (typeof current_value_31 === 'number'){
        default_config['formatter']['s3sv']['indentation_size'] = current_value_31;
    }
            
    // formatter -> verible -> path
    const current_value_32 = json_config['formatter']['verible']['path'];
    if (typeof current_value_32 === 'string'){
        default_config['formatter']['verible']['path'] = current_value_32;
    }
    ...
    const current_value_48 = json_config['linter']['general']['linter_vhdl'];
    ...
    const current_value_49 = json_config['linter']['general']['linter_verilog'];
    ...
    const current_value_50 = json_config['linter']['general']['lstyle_verilog'];
    ...
    const current_value_51 = json_config['linter']['general']['lstyle_vhdl'];
    ...
    const current_value_52 = json_config['linter']['ghdl']['arguments'];
    if (typeof current_value_52 === 'string'){
        default_config['linter']['ghdl']['arguments'] = current_value_52;
    }
            
    // linter -> icarus -> arguments
    const current_value_53 = json_config['linter']['icarus']['arguments'];
    if (typeof current_value_53 === 'string'){
        default_config['linter']['icarus']['arguments'] = current_value_53;
    }
            
    // linter -> modelsim -> vhdl_arguments
    const current_value_54 = json_config['linter']['modelsim']['vhdl_arguments'];
    if (typeof current_value_54 === 'string'){
        default_config['linter']['modelsim']['vhdl_arguments'] = current_value_54;
    }
            
    // linter -> modelsim -> verilog_arguments
    const current_value_55 = json_config['linter']['modelsim']['verilog_arguments'];
    if (typeof current_value_55 === 'string'){
        default_config['linter']['modelsim']['verilog_arguments'] = current_value_55;
    }
            
    // linter -> verible -> arguments
    const current_value_56 = json_config['linter']['verible']['arguments'];
    if (typeof current_value_56 === 'string'){
        default_config['linter']['verible']['arguments'] = current_value_56;
    }
            
    // linter -> verilator -> arguments
    const current_value_57 = json_config['linter']['verilator']['arguments'];
    if (typeof current_value_57 === 'string'){
        default_config['linter']['verilator']['arguments'] = current_value_57;
    }
            
    // linter -> vivado -> vhdl_arguments
    const current_value_58 = json_config['linter']['vivado']['vhdl_arguments'];
    if (typeof current_value_58 === 'string'){
        default_config['linter']['vivado']['vhdl_arguments'] = current_value_58;
    }
            
    // linter -> vivado -> verilog_arguments
    const current_value_59 = json_config['linter']['vivado']['verilog_arguments'];
    if (typeof current_value_59 === 'string'){
        default_config['linter']['vivado']['verilog_arguments'] = current_value_59;
    }
            
    // linter -> vsg -> arguments
    const current_value_60 = json_config['linter']['vsg']['arguments'];
    if (typeof current_value_60 === 'string'){
        default_config['linter']['vsg']['arguments'] = current_value_60;
    }
            
    // schematic -> general -> backend
    const current_value_61 = json_config['schematic']['general']['backend'];
    if ( current_value_61 === "yowasp"){
        default_config['schematic']['general']['backend'] = e_schematic_general_backend.yowasp;
    }
    if ( current_value_61 === "yosys"){
        default_config['schematic']['general']['backend'] = e_schematic_general_backend.yosys;
    }
    if ( current_value_61 === "yosys_ghdl"){
        default_config['schematic']['general']['backend'] = e_schematic_general_backend.yosys_ghdl;
    }
    if ( current_value_61 === "yosys_ghdl_module"){
        default_config['schematic']['general']['backend'] = e_schematic_general_backend.yosys_ghdl_module;
    }
            
    // templates -> general -> header_file_path
    const current_value_62 = json_config['templates']['general']['header_file_path'];
    if (typeof current_value_62 === 'string'){
        default_config['templates']['general']['header_file_path'] = current_value_62;
    }
            
    // templates -> general -> indent
    const current_value_63 = json_config['templates']['general']['indent'];
    if (typeof current_value_63 === 'string'){
        default_config['templates']['general']['indent'] = current_value_63;
    }
            
    // templates -> general -> clock_generation_style
    const current_value_64 = json_config['templates']['general']['clock_generation_style'];
    if ( current_value_64 === "inline"){
        default_config['templates']['general']['clock_generation_style'] = e_templates_general_clock_generation_style.inline;
    }
    if ( current_value_64 === "ifelse"){
    ...
    const current_value_72 = json_config['tools']['ascenlint']['installation_path'];
    if (typeof current_value_72 === 'string'){
        default_config['tools']['ascenlint']['installation_path'] = current_value_72;
    }
            
    // tools -> ascenlint -> ascentlint_options
    const current_value_73 = json_config['tools']['ascenlint']['ascentlint_options'];
    if (Array.isArray(current_value_73)){
        default_config['tools']['ascenlint']['ascentlint_options'] = current_value_73;
    }
            
    // tools -> cocotb -> installation_path
    const current_value_74 = json_config['tools']['cocotb']['installation_path'];
    if (typeof current_value_74 === 'string'){
        default_config['tools']['cocotb']['installation_path'] = current_value_74;
    }
            
    // tools -> cocotb -> simulator_name
    const current_value_75 = json_config['tools']['cocotb']['simulator_name'];
    ...
    if ( current_value_75 === "cvc"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.cvc;
    }
            
    // tools -> cocotb -> compile_args
    const current_value_76 = json_config['tools']['cocotb']['compile_args'];
    if (typeof current_value_76 === 'string'){
        default_config['tools']['cocotb']['compile_args'] = current_value_76;
    }
            
    // tools -> cocotb -> run_args
    const current_value_77 = json_config['tools']['cocotb']['run_args'];
    if (typeof current_value_77 === 'string'){
        default_config['tools']['cocotb']['run_args'] = current_value_77;
    }
            
    // tools -> cocotb -> plusargs
    const current_value_78 = json_config['tools']['cocotb']['plusargs'];
    if (typeof current_value_78 === 'string'){
        default_config['tools']['cocotb']['plusargs'] = current_value_78;
    }
            
    // tools -> diamond -> installation_path
    const current_value_79 = json_config['tools']['diamond']['installation_path'];
    if (typeof current_value_79 === 'string'){
        default_config['tools']['diamond']['installation_path'] = current_value_79;
    }
            
    // tools -> diamond -> part
    const current_value_80 = json_config['tools']['diamond']['part'];
    if (typeof current_value_80 === 'string'){
        default_config['tools']['diamond']['part'] = current_value_80;
    }
            
    // tools -> ghdl -> installation_path
    const current_value_81 = json_config['tools']['ghdl']['installation_path'];
    if (typeof current_value_81 === 'string'){
        default_config['tools']['ghdl']['installation_path'] = current_value_81;
    }
            
    // tools -> ghdl -> waveform
    const current_value_82 = json_config['tools']['ghdl']['waveform'];
    if ( current_value_82 === "vcd"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.vcd;
    }
    if ( current_value_82 === "ghw"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.ghw;
    }
            
    // tools -> ghdl -> analyze_options
    const current_value_83 = json_config['tools']['ghdl']['analyze_options'];
    if (Array.isArray(current_value_83)){
        default_config['tools']['ghdl']['analyze_options'] = current_value_83;
    }
            
    // tools -> ghdl -> run_options
    const current_value_84 = json_config['tools']['ghdl']['run_options'];
    if (Array.isArray(current_value_84)){
        default_config['tools']['ghdl']['run_options'] = current_value_84;
    }
            
    // tools -> icarus -> installation_path
    const current_value_85 = json_config['tools']['icarus']['installation_path'];
    if (typeof current_value_85 === 'string'){
        default_config['tools']['icarus']['installation_path'] = current_value_85;
    }
            
    // tools -> icarus -> timescale
    const current_value_86 = json_config['tools']['icarus']['timescale'];
    if (typeof current_value_86 === 'string'){
        default_config['tools']['icarus']['timescale'] = current_value_86;
    }
            
    // tools -> icarus -> iverilog_options
    const current_value_87 = json_config['tools']['icarus']['iverilog_options'];
    if (Array.isArray(current_value_87)){
        default_config['tools']['icarus']['iverilog_options'] = current_value_87;
    }
            
    // tools -> icestorm -> installation_path
    const current_value_88 = json_config['tools']['icestorm']['installation_path'];
    if (typeof current_value_88 === 'string'){
        default_config['tools']['icestorm']['installation_path'] = current_value_88;
    }
            
    // tools -> icestorm -> pnr
    const current_value_89 = json_config['tools']['icestorm']['pnr'];
    if ( current_value_89 === "arachne"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.arachne;
    }
    if ( current_value_89 === "next"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.next;
    }
    if ( current_value_89 === "none"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.none;
    }
            
    // tools -> icestorm -> arch
    const current_value_90 = json_config['tools']['icestorm']['arch'];
    if ( current_value_90 === "xilinx"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.xilinx;
    }
    if ( current_value_90 === "ice40"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ice40;
    }
    if ( current_value_90 === "ecp5"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ecp5;
    }
            
    // tools -> icestorm -> output_format
    const current_value_91 = json_config['tools']['icestorm']['output_format'];
    if ( current_value_91 === "json"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.json;
    }
    if ( current_value_91 === "edif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.edif;
    }
    if ( current_value_91 === "blif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.blif;
    }
            
    // tools -> icestorm -> yosys_as_subtool
    const current_value_92 = json_config['tools']['icestorm']['yosys_as_subtool'];
    if (current_value_92 === true || current_value_92 === false){
        default_config['tools']['icestorm']['yosys_as_subtool'] = current_value_92;
    }
            
    // tools -> icestorm -> makefile_name
    const current_value_93 = json_config['tools']['icestorm']['makefile_name'];
    if (typeof current_value_93 === 'string'){
        default_config['tools']['icestorm']['makefile_name'] = current_value_93;
    }
            
    // tools -> icestorm -> arachne_pnr_options
    const current_value_94 = json_config['tools']['icestorm']['arachne_pnr_options'];
    if (Array.isArray(current_value_94)){
        default_config['tools']['icestorm']['arachne_pnr_options'] = current_value_94;
    }
            
    // tools -> icestorm -> nextpnr_options
    const current_value_95 = json_config['tools']['icestorm']['nextpnr_options'];
    if (Array.isArray(current_value_95)){
        default_config['tools']['icestorm']['nextpnr_options'] = current_value_95;
    }
            
    // tools -> icestorm -> yosys_synth_options
    const current_value_96 = json_config['tools']['icestorm']['yosys_synth_options'];
    if (Array.isArray(current_value_96)){
        default_config['tools']['icestorm']['yosys_synth_options'] = current_value_96;
    }
            
    // tools -> ise -> installation_path
    const current_value_97 = json_config['tools']['ise']['installation_path'];
    if (typeof current_value_97 === 'string'){
        default_config['tools']['ise']['installation_path'] = current_value_97;
    }
            
    // tools -> ise -> family
    const current_value_98 = json_config['tools']['ise']['family'];
    if (typeof current_value_98 === 'string'){
        default_config['tools']['ise']['family'] = current_value_98;
    }
            
    // tools -> ise -> device
    const current_value_99 = json_config['tools']['ise']['device'];
    if (typeof current_value_99 === 'string'){
        default_config['tools']['ise']['device'] = current_value_99;
    }
            
    // tools -> ise -> package
    const current_value_100 = json_config['tools']['ise']['package'];
    if (typeof current_value_100 === 'string'){
        default_config['tools']['ise']['package'] = current_value_100;
    }
            
    // tools -> ise -> speed
    const current_value_101 = json_config['tools']['ise']['speed'];
    if (typeof current_value_101 === 'string'){
        default_config['tools']['ise']['speed'] = current_value_101;
    }
            
    // tools -> isem -> installation_path
    const current_value_102 = json_config['tools']['isem']['installation_path'];
    if (typeof current_value_102 === 'string'){
        default_config['tools']['isem']['installation_path'] = current_value_102;
    }
            
    // tools -> isem -> fuse_options
    const current_value_103 = json_config['tools']['isem']['fuse_options'];
    if (Array.isArray(current_value_103)){
        default_config['tools']['isem']['fuse_options'] = current_value_103;
    }
            
    // tools -> isem -> isim_options
    const current_value_104 = json_config['tools']['isem']['isim_options'];
    if (Array.isArray(current_value_104)){
        default_config['tools']['isem']['isim_options'] = current_value_104;
    }
            
    // tools -> modelsim -> installation_path
    const current_value_105 = json_config['tools']['modelsim']['installation_path'];
    if (typeof current_value_105 === 'string'){
        default_config['tools']['modelsim']['installation_path'] = current_value_105;
    }
            
    // tools -> modelsim -> vcom_options
    const current_value_106 = json_config['tools']['modelsim']['vcom_options'];
    if (Array.isArray(current_value_106)){
        default_config['tools']['modelsim']['vcom_options'] = current_value_106;
    }
            
    // tools -> modelsim -> vlog_options
    const current_value_107 = json_config['tools']['modelsim']['vlog_options'];
    if (Array.isArray(current_value_107)){
        default_config['tools']['modelsim']['vlog_options'] = current_value_107;
    }
            
    // tools -> modelsim -> vsim_options
    const current_value_108 = json_config['tools']['modelsim']['vsim_options'];
    if (Array.isArray(current_value_108)){
        default_config['tools']['modelsim']['vsim_options'] = current_value_108;
    }
            
    // tools -> morty -> installation_path
    const current_value_109 = json_config['tools']['morty']['installation_path'];
    if (typeof current_value_109 === 'string'){
        default_config['tools']['morty']['installation_path'] = current_value_109;
    }
            
    // tools -> morty -> morty_options
    const current_value_110 = json_config['tools']['morty']['morty_options'];
    if (Array.isArray(current_value_110)){
        default_config['tools']['morty']['morty_options'] = current_value_110;
    }
            
    // tools -> quartus -> installation_path
    const current_value_111 = json_config['tools']['quartus']['installation_path'];
    if (typeof current_value_111 === 'string'){
        default_config['tools']['quartus']['installation_path'] = current_value_111;
    }
            
    // tools -> quartus -> family
    const current_value_112 = json_config['tools']['quartus']['family'];
    if (typeof current_value_112 === 'string'){
        default_config['tools']['quartus']['family'] = current_value_112;
    }
            
    // tools -> quartus -> device
    const current_value_113 = json_config['tools']['quartus']['device'];
    if (typeof current_value_113 === 'string'){
        default_config['tools']['quartus']['device'] = current_value_113;
    }
            
    // tools -> quartus -> cable
    const current_value_114 = json_config['tools']['quartus']['cable'];
    if (typeof current_value_114 === 'string'){
        default_config['tools']['quartus']['cable'] = current_value_114;
    }
            
    // tools -> quartus -> board_device_index
    const current_value_115 = json_config['tools']['quartus']['board_device_index'];
    if (typeof current_value_115 === 'string'){
        default_config['tools']['quartus']['board_device_index'] = current_value_115;
    }
            
    // tools -> quartus -> pnr
    const current_value_116 = json_config['tools']['quartus']['pnr'];
    if ( current_value_116 === "default"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.default;
    }
    if ( current_value_116 === "dse"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.dse;
    }
    if ( current_value_116 === "none"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.none;
    }
            
    // tools -> quartus -> dse_options
    const current_value_117 = json_config['tools']['quartus']['dse_options'];
    if (Array.isArray(current_value_117)){
        default_config['tools']['quartus']['dse_options'] = current_value_117;
    }
            
    // tools -> quartus -> quartus_options
    const current_value_118 = json_config['tools']['quartus']['quartus_options'];
    if (Array.isArray(current_value_118)){
        default_config['tools']['quartus']['quartus_options'] = current_value_118;
    }
            
    // tools -> radiant -> installation_path
    const current_value_119 = json_config['tools']['radiant']['installation_path'];
    if (typeof current_value_119 === 'string'){
        default_config['tools']['radiant']['installation_path'] = current_value_119;
    }
            
    // tools -> radiant -> part
    const current_value_120 = json_config['tools']['radiant']['part'];
    if (typeof current_value_120 === 'string'){
        default_config['tools']['radiant']['part'] = current_value_120;
    }
            
    // tools -> rivierapro -> installation_path
    const current_value_121 = json_config['tools']['rivierapro']['installation_path'];
    if (typeof current_value_121 === 'string'){
        default_config['tools']['rivierapro']['installation_path'] = current_value_121;
    }
            
    // tools -> rivierapro -> compilation_mode
    const current_value_122 = json_config['tools']['rivierapro']['compilation_mode'];
    if (typeof current_value_122 === 'string'){
        default_config['tools']['rivierapro']['compilation_mode'] = current_value_122;
    }
            
    // tools -> rivierapro -> vlog_options
    const current_value_123 = json_config['tools']['rivierapro']['vlog_options'];
    if (Array.isArray(current_value_123)){
        default_config['tools']['rivierapro']['vlog_options'] = current_value_123;
    }
            
    // tools -> rivierapro -> vsim_options
    const current_value_124 = json_config['tools']['rivierapro']['vsim_options'];
    if (Array.isArray(current_value_124)){
        default_config['tools']['rivierapro']['vsim_options'] = current_value_124;
    }
            
    // tools -> siliconcompiler -> installation_path
    const current_value_125 = json_config['tools']['siliconcompiler']['installation_path'];
    if (typeof current_value_125 === 'string'){
        default_config['tools']['siliconcompiler']['installation_path'] = current_value_125;
    }
            
    // tools -> siliconcompiler -> target
    const current_value_126 = json_config['tools']['siliconcompiler']['target'];
    if (typeof current_value_126 === 'string'){
        default_config['tools']['siliconcompiler']['target'] = current_value_126;
    }
            
    // tools -> siliconcompiler -> server_enable
    const current_value_127 = json_config['tools']['siliconcompiler']['server_enable'];
    if (current_value_127 === true || current_value_127 === false){
        default_config['tools']['siliconcompiler']['server_enable'] = current_value_127;
    }
            
    // tools -> siliconcompiler -> server_address
    const current_value_128 = json_config['tools']['siliconcompiler']['server_address'];
    if (typeof current_value_128 === 'string'){
        default_config['tools']['siliconcompiler']['server_address'] = current_value_128;
    }
            
    // tools -> siliconcompiler -> server_username
    const current_value_129 = json_config['tools']['siliconcompiler']['server_username'];
    if (typeof current_value_129 === 'string'){
        default_config['tools']['siliconcompiler']['server_username'] = current_value_129;
    }
            
    // tools -> siliconcompiler -> server_password
    const current_value_130 = json_config['tools']['siliconcompiler']['server_password'];
    if (typeof current_value_130 === 'string'){
        default_config['tools']['siliconcompiler']['server_password'] = current_value_130;
    }
    ...
    const current_value_156 = json_config['tools']['veriblelint']['installation_path'];
    if (typeof current_value_156 === 'string'){
        default_config['tools']['veriblelint']['installation_path'] = current_value_156;
    }
